...
class _$RandomizerStateTearOff {
  ...
  _RandomizerState call({int min = 0, int max = 0, int? generatedValue}) {
...
mixin _$RandomizerState {
  ...
  int? get generatedValue => throw _privateConstructorUsedError;
...
abstract class $RandomizerStateCopyWith<$Res> {
  ...
  $Res call({int min, int max, int? generatedValue});
}
    ...
    return _then(_value.copyWith(
      ...
      max: max == freezed
          ...
          : max // ignore: cast_nullable_to_non_nullable
              as int,
      generatedValue: generatedValue == freezed
          ? _value.generatedValue
          : generatedValue // ignore: cast_nullable_to_non_nullable
              as int?,
    ));
  }
}
...
class _$_RandomizerState extends _RandomizerState {
  const _$_RandomizerState({this.min = 0, this.max = 0, this.generatedValue})
      : super._();
  ...
  final int max;
  @override
  final int? generatedValue;

  @override
  String toString() {
    return 'RandomizerState(min: $min, max: $max, generatedValue: $generatedValue)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.generatedValue, generatedValue));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(generatedValue));
...
abstract class _RandomizerState extends RandomizerState {
  const factory _RandomizerState({int min, int max, int? generatedValue}) =
      _$_RandomizerState;
